...
export const GRIP_RECIPIENTS = [
  ...
  'Mark.Kerr@golfclubs4cash.co.uk',
  'ted.mathers@golfclubs4cash.co.uk',
  'dean.cracknell@golfclubs4cash.co.uk',
]

// POS email — daily 7pm
export const POS_RECIPIENTS = [
  ...GRIP_RECIPIENTS,
  'robert.hughes@golfclubs4cash.co.uk',
  'Anthony.Blaney@golfclubs4cash.co.uk',
  'rory.smith@golfclubs4cash.co.uk',
  'Matt.Petley@golfclubs4cash.co.uk',
]

// Legacy alias — remove once all callers updated
export const REPORT_RECIPIENTS = POS_RECIPIENTS

// Stock Value email — monthly, 00:01 on the 1st. Per Neil Rosie 2026-09-02.
export const STOCK_VALUE_RECIPIENTS = [
  'ted.mathers@golfclubs4cash.co.uk',
  'mark.kerr@golfclubs4cash.co.uk',
]
