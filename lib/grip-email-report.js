...
import { sendEmail, GRIP_RECIPIENTS } from './mailer.js'
  ...
  <div style="background:white;padding:20px 28px;border-bottom:1px solid #eee;">
    <table width="100%" cellspacing="0" cellpadding="0"><tr>
      ...
      <td style="text-align:center;padding:0 16px;border-right:1px solid #eee;">
        ...
        <div style="font-size:11px;color:#888;text-transform:uppercase;letter-spacing:0.05em;margin-top:2px;">of Club Sale Items</div>
      </td>
      <td style="text-align:center;padding:0 0 0 16px;">
        <div style="font-size:28px;font-weight:700;color:#005F2C;">${s.pctRevenue}%</div>
        <div style="font-size:11px;color:#888;text-transform:uppercase;letter-spacing:0.05em;margin-top:2px;">of Club Sale Revenue</div>
      </td>
    </tr></table>
  </div>
  <div style="background:white;padding:0 0 8px;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
      <thead><tr>
        ...
        <th style="${headNum}">Club Sale Items</th><th style="${headNum}">Club Sale Revenue</th>
...
export async function run({ testRecipient, startDate, endDate, label } = {}) {
  ...
  await sendEmail({
    to: testRecipient || GRIP_RECIPIENTS,
