...
<div style="max-width:720px;margin:0 auto;">
  ...
  <div style="background:white;padding:0 0 8px;">
    <div style="padding:16px 28px 4px;font-size:12px;font-weight:700;color:#b45309;text-transform:uppercase;letter-spacing:0.06em;">
      Today &mdash; ${fmtShortDate(ranges.todayStr)}
    </div>
    <div style="padding:0 28px 8px;font-size:11px;color:#999;">LFL vs same day of week last year (${fmtShortDate(ranges.dayLY.start)})</div>
  ...
  <div style="background:white;padding:0 0 8px;border-top:4px solid #f4f5f7;">
    <div style="padding:16px 28px 4px;font-size:12px;font-weight:700;color:#005F2C;text-transform:uppercase;letter-spacing:0.06em;">
      Week to Date &mdash; ${fmtShortDate(ranges.wtd.start)} to Today
    </div>
    <div style="padding:0 28px 8px;font-size:11px;color:#999;">LFL vs same days of week last year (${fmtShortDate(ranges.wtdLY.start)}&ndash;${fmtShortDate(ranges.wtdLY.end)})</div>
    ${sectionTable('wtd', 'wtdLYSales', summaryAtv.wtd || 0, summaryReturnPct.wtd || null)}
  </div>
  <div style="background:white;padding:0 0 8px;border-top:4px solid #f4f5f7;">
    <div style="padding:16px 28px 4px;font-size:12px;font-weight:700;color:#1d4ed8;text-transform:uppercase;letter-spacing:0.06em;">
      Month to Date &mdash; ${fmtShortDate(ranges.mtd.start)} to Today
    </div>
    <div style="padding:0 28px 8px;font-size:11px;color:#999;">LFL vs same dates last year (${fmtShortDate(ranges.mtdLY.start)}&ndash;${fmtShortDate(ranges.mtdLY.end)})</div>
