...
// it cost (we come out up). Superseded the old weight-based (£12/kg) DPD
// payout estimate on 2026-08-31 — the team now enters the real amount being
// claimed for directly, so there's no need to estimate a payout from weight
// any more. E.g. cost £200, claim £120 → shortfall £80. Cost £50, claim £70
// → shortfall -£20 (i.e. £20 up).
