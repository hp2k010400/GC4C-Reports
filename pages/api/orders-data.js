...
export default async function handler(req, res) {
  const { page_info, startDate, endDate, financial_status, fulfillment_status } = req.query
  ...
  try {
    ...
    do {
      const params = currentPageInfo
        ...
        : {
            status: 'any',
            fields: 'id,name,created_at,financial_status,fulfillment_status,customer,line_items,tags,source_name,total_price,total_discounts,discount_codes',
      ...
      const rows = items.flatMap(order =>
