...
// Removes a page from the Brand Hub list by clearing its template back to
// the theme default. Distinct from the in-session "Revert" (which restores
// an exact prior snapshot) — this is for removing an entry days later from
// the tracking list, when no snapshot is held in memory any more.
