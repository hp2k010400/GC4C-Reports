...
const EDITABLE_FIELDS = [
  ...
  'consignment_ref', 'value_tier', 'retail', 'cost', 'claim_amount', 'recovered_amount', 'claim_ref', 'weight_kg',
  'stage', 'issue_type', 'claim_status', 'claim_form_sent_at',
  'claim_form_received_at', 'notes', 'handled_by',
]
const NUMERIC_FIELDS = ['retail', 'cost', 'claim_amount', 'recovered_amount', 'weight_kg']
